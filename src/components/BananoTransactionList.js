...
export default function BananoTransactionList({ transactions, userAddress }) {
    ...
    <View style={styles.transactionHistory}>
      ...
      {processedTransactions.length === 0 ? (
        ...
        processedTransactions.map((tx, index) => {
          ...
          const banAmount = tools.convert(tx.amount, "RAW", "BAN");
          const banAmountFormatted = parseFloat(banAmount).toFixed(6);
